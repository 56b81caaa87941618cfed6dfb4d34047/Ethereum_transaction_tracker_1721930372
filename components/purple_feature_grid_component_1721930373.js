...
Vue.component("purple_feature_grid_component_1721930373", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the game with our cutting-edge technology that monitors the Ethereum blockchain in real-time, ensuring you never miss a single transaction.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Gain valuable insights into every transaction with our in-depth analysis, providing you with detailed information on senders, recipients, amounts, and more.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Customizable Alerts and Notifications</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Tailor the app to your specific needs by setting up personalized alerts and notifications for transactions that match your criteria, keeping you informed at all times.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Navigate through our intuitive and sleek interface, designed to provide you with a seamless experience, making it easy to find and analyze the transactions you're interested in.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Rest assured that your data is safe with our robust security measures, ensuring the utmost privacy and protection for your valuable transaction information.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Continuous Updates and Improvements</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">We are committed to delivering the best possible experience by continuously updating and improving our app, incorporating the latest advancements in blockchain technology.</p></div>
        </div>
    </div>`,
        data() {
            return {
